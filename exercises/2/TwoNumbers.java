...
public class TwoNumbers{
  public static void main(String[] args){
    ...
    x = 3; y = 10;
     ...
     result1 = y / x;
     result2 = y % x;
     System.out.println(y + " divided by " + x + " is " + result1);
     System.out.println(y + " modulus " + x + " is " + result2);
     System.out.println("This is the tab escape codes in action\t..saw what happened?");
